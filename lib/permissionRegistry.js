...
export const PERMISSION_REGISTRY = [
  ...
  { key: 'apri.view.financials', label: 'View APRI financial details', group: 'apri', description: 'View prices, totals, currency, and exchange rate on APRI documents.', active: true },
...
export const PERMISSION_LEGACY_ALIASES = {
  ...
  'apri.view.financials': ['apri.create', 'apinvoice.create'],
