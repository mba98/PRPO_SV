...
export async function listUsersPicklist() {
  await connectDB();
...
export async function createUser(data) {
  ...
  try {
    const user = await User.create({
      ...
      sapRequesterCode: data.sapRequesterCode?.trim() || undefined,
...
export async function updateUser(id, data) {
  ...
  if (data.sapRequesterCode !== undefined) {
    updates.sapRequesterCode = data.sapRequesterCode?.trim() || undefined;
  }
