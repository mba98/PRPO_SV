...
export async function notifyEvent(eventKey, { subject, body, html, relatedDocumentType, relatedDocumentId }) {
...
/**
 * Build subject/html/text from a workflow template key and send the notification.
 */
