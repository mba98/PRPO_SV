...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: ['lp.create', 'lp.approve.pm', 'lp.approve.finance', 'lp.view.all', 'lp.cancel'],
  },
  {
    id: 'items',
    label: 'Items',
...
export const PERMISSION_LABELS = {
  ...
  'lp.create': 'Create local purchases',
  'lp.approve.pm': 'Approve Local Purchase — project manager',
  'lp.approve.finance': 'Approve Local Purchase — finance',
  'lp.view.all': 'View all local purchases',
  'lp.cancel': 'Cancel local purchases',
