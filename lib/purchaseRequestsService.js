...
export async function submitPurchaseRequest(id, user, { __v } = {}) {
  ...
  await notifyWorkflowEmail(
    'pr.created',
    { portalPRNumber: pr.portalPRNumber, documentId: pr._id.toString() },
...
export async function rejectPurchaseRequest(id, user, { comment, __v } = {}) {
  ...
  await notifyWorkflowEmail(
    'pr.rejected',
    { portalPRNumber: pr.portalPRNumber, documentId: pr._id.toString(), comment },
    { documentType: 'PR', documentId: pr._id.toString() },
  );
