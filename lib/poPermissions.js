...
import { userHasAdminSapRetryAccess } from '@/lib/sapRetryAuth.js';
...
/** @deprecated Use canUserRetrySapDocument with document context — admin-only shortcut */
export const PO_RETRY_SAP_PERMISSIONS = ['admin.settings', 'view.all'];
