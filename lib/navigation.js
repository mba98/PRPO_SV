...
export const SETTINGS_NAV = [
  ...
  { labelKey: 'emailGroups', href: '/settings/email-groups', permissions: ['admin.email_groups', 'admin.settings'] },
  {
    labelKey: 'sapIntegration',
    href: '/settings/sap-integration',
    permissions: ['admin.sap_integration', 'admin.settings'],
  },
  {
    labelKey: 'systemLogs',
    href: '/settings/system-logs',
    permissions: ['admin.system_logs', 'admin.settings'],
  },
];
